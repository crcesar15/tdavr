                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <button type="button" class="btn btn-success" onclick="getUserInfo({{$patient->user->id}})" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-eye"></i> Ver</button>
                                            <button type="button" class="btn btn-primary" onclick="editUserInfo({{$patient->user->id}})" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-edit"></i> Editar</button>
                                            <button type="button" class="btn btn-danger" onclick="deletePatient({{$patient->user->id}})"><i class="fa fa-trash"></i> Inhablitar</button>
                                        </div>
                                    </td>
                                </tr>
                            @empty
